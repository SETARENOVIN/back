...
install_marzhelp() {
    ...
    mysql -h 127.0.0.1 -u marzban -p"$MYSQL_ROOT_PASSWORD" -e "CREATE DATABASE IF NOT EXISTS marzhelp;"

    # Create the user_deletions table in the Marzban database
    mysql -h 127.0.0.1 -u marzban -p"$MYSQL_ROOT_PASSWORD" "$vpnDbName" <<EOF
